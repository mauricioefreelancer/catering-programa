...
BEGIN
    ...
    -- IMPORTANTE: Siempre usar to_jsonb() NUNCA cast ::jsonb sobre rowtype
    -- PostgreSQL no provee cast implícito composite -> jsonb
    ...
    v_old_json := v_old_row;
    v_new_json := v_new_row;
...
(async () => {
  try {
    console.log('🔧 Aplicando PARCHE v2: fn_audit_trigger_generico (sin casts ::jsonb)...');
    ...
    console.log('✅ Parche v2 OK. No más casts ::jsonb inválidos.');
  } catch (e) {
